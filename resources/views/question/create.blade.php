            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <small id="questionHelp" class="form-text text-muted">Ask single and to-the-point question for best results.</small>
                    ...
                    <div class="form-group">
                        <fieldset>
                            ...
                            <small id="choicesHelp" class="form-text text-muted">Give choices that give you the most insight of your question.</small>
